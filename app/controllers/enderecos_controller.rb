class EnderecosController < ApplicationController
  ...
  def create
    ...
    @endereco.cliente = Cliente.last

    respond_to do |format|
      if @endereco.save
        format.html { redirect_to @endereco.cliente, notice: 'Endereco was successfully created.' }
  ...
  private
    ...
    def endereco_params
      params.require(:endereco).permit(:logradouro, :numero, :bairro, :complemento, :cidade, :estado)
    end
end
