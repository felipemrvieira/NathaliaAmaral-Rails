...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { codigoNF: @compra.codigoNF, dataCompra: @compra.dataCompra, hitorico: @compra.hitorico, prcelamento: @compra.prcelamento, valor: @compra.valor } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { codigoNF: @compra.codigoNF, dataCompra: @compra.dataCompra, hitorico: @compra.hitorico, prcelamento: @compra.prcelamento, valor: @compra.valor } }
